  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(`Incorrect code. Error: ${errorData.error}`);
      }
    } catch (error) {
    ...
    <div className="h-full bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-16 px-4">
      ...
      <img src="https://entrebyte.co.za/wp-content/uploads/2022/12/white-logo-vector.png" alt="Logo" className="h-24 mb-8" />
        ...
        <button aria-label="Continue with google" role="button" className="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                        ...
                        <p className="md:md:text-base text-sm font-medium ml-4 text-sm text-gray-700">Continue with Google</p>
                    </button>
                    <button aria-label="Continue with github" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p className="md:text-base text-sm font-medium ml-4 text-gray-700">Continue with Github</p>
                    </button>
                    <button aria-label="Continue with twitter" role="button" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
                        ...
                        <p className="md:text-base text-sm font-medium ml-4 text-gray-700">Continue with Twitter</p>
                    </button>
                    <div className="w-full flex items-center justify-between py-5">
                        <hr className="w-full bg-gray-400" />
                        <p className="md:text-base text-sm font-medium leading-4 px-2.5 text-gray-400">OR</p>
                        <hr className="w-full bg-gray-400  " />
                    </div>
          ...
          <p className="text-sm mt-4 font-medium leading-none text-gray-500">
            ...
            <a href="/Register" className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
              Sign up here
            </a>
          </p>
