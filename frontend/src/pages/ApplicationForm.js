...
const ApplicationForm = ({ jobSlug }) => {
  ...
  <div className="h-full">
    <div className="grid grid-cols-1 md:grid-cols-2">
      <div className="bg-center bg-cover md:bg-cover md:bg-center h-full" style={{ backgroundImage: "url('https://images.pexels.com/photos/3205567/pexels-photo-3205567.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')" }}>
      </div>
